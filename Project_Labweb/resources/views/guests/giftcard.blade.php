...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6 col-sm-12 text-center" style="padding-top: 50px;padding-bottom: 50px; padding-left: 50px">
            <img src="{{ asset('storage/img/giftcard.png') }}" style="height:auto;max-width:inherit">
        </div>
        <div class="col-md-6 col-sm-12 text-center" style="padding-top: 50px;padding-bottom: 50px; padding-right: 50px">
            <div class="text-center">
                ...
                <h6 class="product-desc">
                    O destinatário irá receber um email com o teu presente, basta contactar a loja para reservar a experiência VR.
                ...
                <select class="form-select text-center" name="price" aria-label="select-price" style="width:200px;display:inline" id="selectHour">
                ...
                <p class="page-subtitle" style="font-size:16px !important;padding-top:20px;">ESCOLHA O DESTINATÁRIO (E-MAIL)</p>
